...
const app: I18nLocales = {
    ...
    a_enter_product_title:'Ingresar título del producto',
    a_enter_price:'Ingresar Precio',
    a_enter_name: 'Ingresar Nombre',
    a_enter_title: 'Ingresar titulo de la categoria',
    ...
    a_products_information: 'Información del Producto',
    ...
    a_select_categorys: 'Seleccionar Categoria',
    a_send: 'Enviar',
...
const errors: I18nLocales = {
    ...
    err_save_category: 'Error al guardar la categoria',
...
const roles: I18nLocales = {
    ...
    c_removed: 'Se ha eliminado la categoria correctamente',
    c_remove: '¿Está seguro que desea eliminar esta categoria?',
    r_search: '{count, plural, one {Buscar rol} other {Buscar roles}}',
    r_update: 'Editar Rol',
    c_update: 'Editar Categoria',
    r_updated: 'Rol Actualizado',
    c_updated: 'Categoria Actualizada',
    c_list: 'Listado de Categorias',
    c_create: 'Crear Categoria'
};
...
const user: I18nLocales = {
    ...
    p_update: 'Actualizar Producto',
    u_users: 'Usuarios',
    u_cagetory: 'Categoria',
    u_view: 'Ver Usuario',
    p_list:'Lista de Productos',
